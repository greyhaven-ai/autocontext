...
from mts.scenarios.custom.designer import SPEC_END, SPEC_START, parse_spec_from_response
...
class TestGenerateSpec:
    ...
    def test_spec_is_valid(self, creator: ScenarioCreator) -> None:
        from mts.scenarios.custom.validator import validate_spec
...
class TestBuildAndValidate:
    ...
    def test_loaded_class_in_sys_modules(self, creator: ScenarioCreator) -> None:
        ...
        creator.build_and_validate(spec)
        module_name = f"mts.scenarios.custom.generated.{spec.name}"

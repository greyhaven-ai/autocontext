...
class TestProviderClass:
    def test_all_classes_defined(self) -> None:
        from mts.agents.role_router import ProviderClass
...
class TestProviderConfig:
    def test_create_config(self) -> None:
        from mts.agents.role_router import ProviderClass, ProviderConfig
...
class TestRoutingContext:
    def test_defaults(self) -> None:
        from mts.agents.role_router import RoutingContext
...
class TestDefaultRoutingTable:
    def test_default_table_has_all_roles(self) -> None:
        from mts.agents.role_router import DEFAULT_ROUTING_TABLE
    ...
    def test_competitor_prefers_frontier(self) -> None:
        from mts.agents.role_router import DEFAULT_ROUTING_TABLE, ProviderClass
...
class TestRoleRouterAutoMode:
    def test_auto_routes_competitor_to_frontier(self) -> None:
        from mts.agents.role_router import ProviderClass, RoleRouter
    ...
    def test_auto_returns_correct_model_for_frontier(self) -> None:
        from mts.agents.role_router import RoleRouter
...
class TestCostEstimation:
    ...
    def test_cost_for_local_is_zero(self) -> None:
        from mts.agents.role_router import RoleRouter, RoutingContext
...
class TestSettings:
    ...
    def test_role_routing_auto(self) -> None:
        ...
        with patch.dict(os.environ, {"MTS_ROLE_ROUTING": "auto"}):
            s = load_settings()

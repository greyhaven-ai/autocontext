...
from mts.harness.validation import (
    StageResult,
    StageStatus,
    ValidationPipeline,
    ValidationStage,
...
class TestValidationPipeline:
    ...
    def test_imports_from_package_init(self) -> None:
        """Types should be importable from mts.harness.validation directly."""
        from mts.harness.validation import StageResult as SR
        from mts.harness.validation import StageStatus as SS
        from mts.harness.validation import ValidationPipeline as VP
        from mts.harness.validation import ValidationStage as VS

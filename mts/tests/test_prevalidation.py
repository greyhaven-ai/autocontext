...
class TestFormatRevisionPrompt:
    def test_format_revision_prompt_includes_errors(self) -> None:
        ...
        from mts.execution.strategy_validator import StrategyValidator, ValidationResult
...
class TestConfigFields:
    ...
    def test_config_env_vars(self) -> None:
        ...
        with patch.dict(
            "os.environ",
            {
                "MTS_PREVALIDATION_ENABLED": "true",
                "MTS_PREVALIDATION_MAX_RETRIES": "3",
            },
        ):
...
class TestPipelineWiring:
    def test_generation_pipeline_imports_stage_prevalidation(self) -> None:
        ...
        import mts.loop.generation_pipeline as gp
    ...
    def test_stage_prevalidation_is_patchable(self) -> None:
        ...
        with patch("mts.loop.generation_pipeline.stage_prevalidation") as mock_stage:

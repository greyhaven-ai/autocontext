"""OpenClaw agent adapter for running agents inside the MTS harness (AC-193).
...
class OpenClawExecutionTrace:
    ...
    def to_role_usage(self) -> RoleUsage:
        """Convert trace usage into MTS RoleUsage."""
        return RoleUsage(
    ...
    def to_evaluation_summary(self) -> dict[str, Any]:
        """Build a summary dict suitable for MTS evaluation records."""
        return {
    ...
    def to_role_execution(self, role: str) -> RoleExecution:
        """Convert trace into an MTS RoleExecution record."""
...
class OpenClawAgentProtocol(Protocol):
    ...
    used as an OpenClaw agent inside the MTS harness.
    """
...
class OpenClawClient(LanguageModelClient):
    ...
    def generate(
        ...
        *,
        ...
        """Execute the OpenClaw agent and return an MTS ModelResponse."""

...
export function renderAgentAppFetchEntrypointTemplate(
  ...
  return [
    ...
    "    authToken: hostCapabilities.authToken,",
    "    authCredentials: hostCapabilities.authCredentials,",
    "    authenticator: hostCapabilities.authenticator,",
    "    allowedOrigins: hostCapabilities.allowedOrigins,",
    ...
    "    runtimeFactoryName: hostCapabilities.runtimeFactoryName,",
    "    runtimeFactoryPlan: hostCapabilities.runtimeFactoryPlan,",
    "    runtimeFactoryModuleMap: hostCapabilities.runtimeFactoryModuleMap,",

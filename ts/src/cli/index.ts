...
Options:
  ...
  --family <name>          Scenario family (default: inferred)
  ...
  --mode <mode>            Training mode: from_scratch, adapter_finetune, full_finetune
  --base-model <id>        Base model for adapter/full fine-tune (e.g., Qwen/Qwen3-0.6B)
  -o, --output <dir>       Output directory (default: models/<scenario>/<backend>)
  --json                   Output as JSON
  -h, --help               Show this help`);
    process.exit(0);
  }

"""AC-196: Analytics-owned weakness reports for recurring failure patterns.
...
class WeaknessReport(BaseModel):
    ...
    def to_markdown(self) -> str:
        ...
        lines.append(f"**Summary:** {len(self.weaknesses)} weaknesses ({len(high)} high, {len(medium)} medium, {len(low)} low)")
        lines.append("")

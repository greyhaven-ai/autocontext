"""Deprecated AC-236 structured lesson persistence compatibility types.
...
not use ``lessons.json`` as a lesson source of truth. AC-946 re-homed this
persistence implementation under storage while preserving the old import path.
"""
